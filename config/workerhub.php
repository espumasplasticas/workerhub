...
return [
    ...
    'queues' => [
        ...
        'deliveries_default' => env('WORKERHUB_DELIVERIES_QUEUE', 'deliveries-default'),
        'deliveries_high' => env('WORKERHUB_DELIVERIES_HIGH_QUEUE', 'deliveries-high'),
    ...
    'orders' => [
        ...
        'tables' => [
            ...
            'gift_orders' => env('WORKERHUB_ORDER_GIFT_ORDERS_TABLE', 'pos.pedido_obsequios'),
            'domiciles' => env('WORKERHUB_ORDER_DOMICILES_TABLE', 'logistica.domicilios_encabezado'),
            ...
            'city_sectors' => env('WORKERHUB_ORDER_CITY_SECTORS_TABLE', 'logistica.ciudad_sector'),
            'postal_code_sectors' => env('WORKERHUB_ORDER_POSTAL_CODE_SECTORS_TABLE', 'logistica.codigo_postal_sector'),
            'production_tickets' => env('WORKERHUB_ORDER_PRODUCTION_TICKETS_TABLE', 'produccion.fichos_comodisimos'),
        ],
        'enterprise_state' => [
            'tables' => [
                ...
                'warehouses' => env('WORKERHUB_ORDER_ENTERPRISE_WAREHOUSES_TABLE', 'SiesaEnterprise.dbo.t150_mc_bodegas'),
                'third_parties' => env('WORKERHUB_ORDER_ENTERPRISE_THIRD_PARTIES_TABLE', 'SiesaEnterprise.dbo.t200_mm_terceros'),
                'clients' => env('WORKERHUB_ORDER_ENTERPRISE_CLIENTS_TABLE', 'SiesaEnterprise.dbo.t201_mm_clientes'),
                'contacts' => env('WORKERHUB_ORDER_ENTERPRISE_CONTACTS_TABLE', 'SiesaEnterprise.dbo.t419_mc_contactos_docto'),
                'countries' => env('WORKERHUB_ORDER_ENTERPRISE_COUNTRIES_TABLE', 'SiesaEnterprise.dbo.t011_mm_paises'),
                'departments' => env('WORKERHUB_ORDER_ENTERPRISE_DEPARTMENTS_TABLE', 'SiesaEnterprise.dbo.t012_mm_deptos'),
                'cities' => env('WORKERHUB_ORDER_ENTERPRISE_CITIES_TABLE', 'SiesaEnterprise.dbo.t013_mm_ciudades'),
            ],
        ],
        'legacy_state' => [
        ...
        'delivery_generation' => [
            'enabled' => filter_var(env('WORKERHUB_ORDER_DELIVERY_GENERATION_ENABLED', true), FILTER_VALIDATE_BOOL),
            'service_user_id' => (int) env('WORKERHUB_ORDER_DELIVERY_SERVICE_USER_ID', 285),
            'pick_matching_procedure' => env('WORKERHUB_ORDER_DELIVERY_PICK_MATCHING_PROCEDURE', 'logistica.usp_lista_picking_entregas_marcar_match'),
            'default_type' => env('WORKERHUB_ORDER_DELIVERY_DEFAULT_TYPE', 'DMED'),
            'special_document_types' => array_values(array_filter(array_map(
                'trim',
                explode(',', (string) env('WORKERHUB_ORDER_DELIVERY_SPECIAL_DOCUMENT_TYPES', 'A93,A70,J1'))
            ))),
            'dispatch_warehouse_equivalents' => [
                '00345' => env('WORKERHUB_ORDER_DELIVERY_EQUIVALENT_WAREHOUSE_00345', '00346'),
                '00745' => env('WORKERHUB_ORDER_DELIVERY_EQUIVALENT_WAREHOUSE_00745', '00726'),
                '00645' => env('WORKERHUB_ORDER_DELIVERY_EQUIVALENT_WAREHOUSE_00645', '00612'),
                '01345' => env('WORKERHUB_ORDER_DELIVERY_EQUIVALENT_WAREHOUSE_01345', '01300'),
                '00545' => env('WORKERHUB_ORDER_DELIVERY_EQUIVALENT_WAREHOUSE_00545', '00588'),
                '04445' => env('WORKERHUB_ORDER_DELIVERY_EQUIVALENT_WAREHOUSE_04445', '00344'),
                '00145' => env('WORKERHUB_ORDER_DELIVERY_EQUIVALENT_WAREHOUSE_00145', '00141'),
                '00445' => env('WORKERHUB_ORDER_DELIVERY_EQUIVALENT_WAREHOUSE_00445', '00141'),
                '00155' => env('WORKERHUB_ORDER_DELIVERY_EQUIVALENT_WAREHOUSE_00155', '00141'),
            ],
        ],
    ],
    ...
    'processes' => [
        'receipts' => [
            ...
            'topics' => [
                'requests' => env('KAFKA_TOPIC_RECEIPTS_REQUESTS', 'workerhub.tasks.requests.receipts'),
        ...
        'sales_orders' => [
            ...
            'topics' => [
                'requests' => env('KAFKA_TOPIC_SALES_ORDERS_REQUESTS', 'workerhub.tasks.requests.sales_orders'),
        ...
        'deliveries' => [
            'label' => 'Domicilios',
            'description' => 'Generacion y sincronizacion de domicilios posteriores a la migracion del pedido.',
            'keywords' => ['domicilio', 'domicilios', 'delivery', 'deliveries'],
            'runtime' => env('WORKERHUB_DELIVERIES_RUNTIME', 'php'),
            'queues' => [
                'default' => env('WORKERHUB_DELIVERIES_QUEUE', 'deliveries-default'),
                'high' => env('WORKERHUB_DELIVERIES_HIGH_QUEUE', 'deliveries-high'),
            ],
            'topics' => [
        ...
        'invoices' => [
            ...
            'topics' => [
                'requests' => env('KAFKA_TOPIC_INVOICES_REQUESTS', 'workerhub.tasks.requests.invoices'),
        ...
        'customers' => [
            ...
            'topics' => [
                'requests' => env('KAFKA_TOPIC_CUSTOMERS_REQUESTS', 'workerhub.tasks.requests.customers'),
        ...
        'general' => [
            ...
            'topics' => [
                'requests' => env('KAFKA_TOPIC_GENERAL_REQUESTS', env('KAFKA_TOPIC_REQUESTS', 'workerhub.tasks.requests.general')),
